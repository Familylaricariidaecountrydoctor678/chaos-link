...
Invoke-ps2exe -inputFile '$inputPath' -outputFile '$compiledPath' -x64 -STA -requireAdmin -supportOS -title '$safeTitle' -description '$safeDescription' -company 'Chaos Link' -product 'Chaos Link' -version '0.2.1.0'
